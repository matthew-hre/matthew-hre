  ...
  return (
    <main>
      ...
      <p>
        ...
        <a href="https://discord.gg/ucGcvKK">Ludum Dare Discord server</a>. You
        get a tiny plot of land, and need to expand. This was a fun little
        project that I still have tons of ideas for, and would love to remake
        one of these days.
      </p>

      <h3>
        <a href="https://whycardboard.itch.io/depopulator"> (de)populator </a>
      </h3>
      <img
      ...
      <p>
        ...
        <a href="https://en.wikipedia.org/wiki/Rorschach_test">
        ...
        <a href="https://store.steampowered.com/app/1499210/Rorschach_Plus/">
          Steam release
        </a>{" "}
        by my good buddy <a href="https://emcannon.itch.io">EmCannon</a>, so
        give that a look.
      </p>
      ...
      <p>
        ...
        <a href="https://en.wikipedia.org/wiki/Roguelike">roguelikes</a> during
        this period, and wanted to try my hand at developing my own. This one
        revolved around a shrinking viewport, which was based on both your
        health and your ammo.
      </p>
      <h3>
        <a href="https://whycardboard.itch.io/bloodsucker">bloodsucker</a>
      </h3>
      <img
      ...
      <p>
        Heavily inspired by{" "}
        <a href="https://en.wikipedia.org/wiki/Splendor_(game)">Splendor</a>,
