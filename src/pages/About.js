  ...
  return (
    <main>
      ...
      <p>
        ...
        programming" option. it sucked, big time. the teacher had no idea how to
        teach programming, and we all ended up on some crappy website to
        practically teach ourselves. luckily, i had some experience, and a dad
        who knew how to get ubuntu and apache running on an old laptop. i ended
        up building a chat client from the ground up: front end, all styled, php
        backend with a mysql database. was also lost to time, unfortunately.
      </p>
      <p>
