...
description: A guide for students transitioning from Python to Java.
createdDate: 2023-01-26T10:20:00.000Z
lastModifiedDate: 2023-05-21T12:18:00.000Z
tags:
  - Python
  - Java
  - Guide
...
This was written back in my first semester of university, as the semester began to wrap up. My section was a bit spooked around the concept of moving to Java,
so I wrote this to help them out. This used to be a GitHub repo with nothing but a readme, but in an effort to clean up my GitHub (and bulk up this site), I've moved it here.
This was posted on the course's homepage for a while, although I'm not sure if it's still being used or not.
...
1. See how we're doing `variable += 1` and `variable -= 1`. This is so common in Java that there's a shortcut for it: `variable++` or `variable--`! It's called the increment or decrement operator, and it's a nice little shortcut of adding or subtracting by 1!
